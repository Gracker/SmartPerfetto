...
如果你希望直接从源码 checkout 启动，使用这个方式。前置条件：**Node.js 18+**、`curl`、`lsof`、`pkill`，以及一个大模型 API Key。Windows 用户请使用 [WSL2](https://learn.microsoft.com/zh-cn/windows/wsl/install) 或 Docker。
